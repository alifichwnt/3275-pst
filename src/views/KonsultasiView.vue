  ...
  <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="mt-6 grid gap-6 md:grid-cols-[1.2fr_.8fr] items-start">
      <div class="rounded-xl border bg-white p-6 shadow-sm">
        ...
        <div v-if="lastResponse" class="mt-6 rounded-lg border bg-emerald-50 p-4 text-emerald-900">
...
const comment = ref('')
function rate() {
  addRating({ serviceType: 'konsultasi', score: score.value, comment: comment.value })
  score.value = 5
  comment.value = ''
